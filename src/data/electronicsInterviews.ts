...
export const electronicsInterviews: BatchInterview[] = [
  {
    year: "K16",
    prefix: "electronics",
    interviews: [
      {
        ...
        interviewContent: `<strong>Q1. In which company have you been placed
      ...
      },
      {
        name: "RISHABH KUMAR",
        company: " SYNOPSYS",
        image: "/alumni/k16/rishab_bhaiya_k16.jpg",
        interviewContent: `<strong>Q. Tell us something about your college life and experiences?</strong>
          <br>
    ...
    interviews: [
      {
        ...
        image: "https://miro.medium.com/max/1000/1*_ifWCIFN2-_75pjeNZskJg.png",
      ...
      },
      {
        name: "AMRIT RAJ",
        company: "ADDVERB",
        image: "https://miro.medium.com/max/500/1*haZAVYvgpSQ4ebb94iMopQ.png",
        facebookInterviewLink:
        ...
        <br>
        Ans. There were four rounds of interviewContent: two were technical and two were HR rounds. There were no written tests for this company, they directly shortlisted for the first round based on the resumes. In the first round, I was asked questions related to my IoT project ‘Smart Mart’ and E-yantra project. I was asked a question about different communication protocols used in the field of electronics. In the second round I was asked about microprocessors and Robotics. Then, they asked me questions related to the various projects that I had done during internships. In the 3rd round (HR round), I was questioned about the challenges that I faced while leading my team to the finals at IIT Bombay and also about my role as the President of EEESoc. The fourth round was actually an interaction with the co-founder of the company which is basically robotics and automation driven.
    ...
    interviews: [
      {
        name: "Rishav Raj",
        company: "Synopsys",
        image: "https://miro.medium.com/max/1400/1*-CPwj7xpMvFh3uGe2V0H1g.jpeg",
        facebookInterviewLink:
      ...
      },
      {
        ...
        image: "https://miro.medium.com/max/875/1*iAmr9KKUhNOmZ9s_kn14Og.jpeg",
        facebookInterviewLink:
      ...
      },
      {
        name: "Saurav Gupta",
        company: "Synopsys",
        image: "https://miro.medium.com/max/875/1*OEkgvQjEmRo-30lVe-wNwg.jpeg",
        facebookInterviewLink:
