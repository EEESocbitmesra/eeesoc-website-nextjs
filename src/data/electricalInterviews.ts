import { BatchAlumni, BatchInterview } from "@/types/types";

export const electricalInterviews: BatchInterview[] = [
  {
    year: "K16",
    prefix: "electrical",
    interviews: [
    ...
    interviews: [
      {
        ...
        image: "https://miro.medium.com/max/719/1*CVGeh7DanFpvVgORVvzWSQ.jpeg",
        facebookInterviewLink:
      ...
      },
      {
        ...
        image: "https://miro.medium.com/max/793/1*BEo-6YTL4jqRKbuf7qXgsw.jpeg",
        facebookInterviewLink:
    ...
    interviews: [
      {
        ...
        image: "https://miro.medium.com/max/1400/1*E2G4HgrLbLDft4YJhRvXyQ.jpeg",
        company: "TATA Motors",
        interviewContent: `<strong>Q1. Which company you have been placed in and what’s your job description?</strong>
        <br>
